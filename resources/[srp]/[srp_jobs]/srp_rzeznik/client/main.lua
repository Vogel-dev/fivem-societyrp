...
---
			...
			if dist <= 2.5 then
			DrawText3D(startX, startY, startZ, "~g~~h~[E]~h~~w~ Aby rozpocząć łapanie kurczaków")
			end
--
            if dist <= 0.5 then
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(0)
			...
			if dist <= 2.5 then
			DrawText3D(przetworniaX, przetworniaY, przetworniaZ, "~g~~h~[E]~h~~w~ Aby porcjować kurczaka")
			end
			...
			if dist2 <= 2.5 then
			DrawText3D(przetworniaX2, przetworniaY2, przetworniaZ2, "~g~~h~[E]~h~~w~ Aby porcjować kurczaka")
			end
			...
			DrawText3D(pakowanieX, pakowanieY, pakowanieZ, "~g~~h~[E]~h~~w~ Aby pakować kurczaka")
			elseif distP <= 2.5 and pakuje == 1 then
			DrawText3D(pakowanieX, pakowanieY, pakowanieZ, "~g~~h~[G]~h~~w~ Aby przerwać pakowanie")
			DrawText3D(pakowanieX, pakowanieY, pakowanieZ+0.1, "~g~~h~[E]~h~~w~ Aby pakować dalej")
			end
...
if akcja == true then
	...
	if dist <= 1.0 then
	DrawText3D(kurczak1Coords.x, kurczak1Coords.y, kurczak1Coords.z+0.5, "~o~~h~[E]~h~~b~ Złap kurczaka")
		if IsControlJustPressed(0, Keys['E']) then 
		Zlapany1 = 1
		ZostalZlapany()
		end	
	elseif dist2 <= 1.0 then
		DrawText3D(kurczak2Coords.x, kurczak2Coords.y, kurczak2Coords.z+0.5, "~o~~h~[E]~h~~b~ Złap kurczaka")
		if IsControlJustPressed(0, Keys['E']) then 
		Zlapany2 = 1
		ZostalZlapany()
		end	
	elseif dist3 <= 1.0 then
		DrawText3D(kurczak3Coords.x, kurczak3Coords.y, kurczak3Coords.z+0.5, "~o~~h~[E]~h~~b~ Złap kurczaka")
		if IsControlJustPressed(0, Keys['E']) then 
		Zlapany3 = 1
		ZostalZlapany()
		end	
