...
Config.nameJobLabel               = "Elektryk"
Config.platePrefix                = "ELEK"
Config.Locale                     = 'fr'
...
Config.Zones = {
  ...
  Cloakroom = {
	...
	BlipSprite = 354,
	BlipColor = 46,
	BlipName = Config.nameJobLabel.." : Rozpoczęcie pracy",
	hint = 'Wciśnij ~INPUT_CONTEXT~ aby ~y~rozpocząć pracę',
  },
  ...
  VehicleSpawner = {
	...
	Color = {r = 11, g = 203, b = 159},
	Type  = 1,
	BlipName = Config.nameJobLabel.." : Pojazd",
	hint = 'Wciśnij ~INPUT_CONTEXT~ aby ~y~wyjąć pojazd służbowy',
  },
  ...
  VehicleDeleter = {
	...
	Color = {r = 255, g = 0, b = 0},
	Type  = 1,
	BlipName = Config.nameJobLabel.." : Zwróc pojazd",
	hint = 'Wciśnij ~INPUT_CONTEXT~ aby ~y~zwrócić pojazd',
  },
  ...
  Vente = {
	...
	Color = {r = 11, g = 203, b = 159},
	Type  = 1,
	BlipName = Config.nameJobLabel.." : Wypłata wynagrodzenia",

	ItemTime = 500,
	ItemDb_name = "pay_works",
	ItemName = "Zniszczony generator",
	ItemMax = 45,
	ItemAdd = 1,
	ItemRemove = 1,
	ItemRequires = "pay_works",
	ItemRequires_name = "Zniszczony generator",
	ItemDrop = 100,
	ItemPrice  = 170,
	hint = 'Wciśnij ~INPUT_CONTEXT~ aby ~y~odebrać wynagrodzenie',
  },
