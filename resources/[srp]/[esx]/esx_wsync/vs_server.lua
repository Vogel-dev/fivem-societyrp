...
end, {help = "Set weather type", params = {{name = "weatherType", help = "Available types: extrasunny, clear, neutral, smog, foggy, overcast, clouds, clearing, thunder, snow, blizzard, snowlight, xmas & halloween"}}})
...
function NextWeatherStage()
	if CurrentWeather == "EXTRASUNNY" or CurrentWeather == "EXTRASUNNY" or CurrentWeather == "EXTRASUNNY"  then
	...
	elseif CurrentWeather == "EXTRASUNNY" or CurrentWeather == "EXTRASUNNY" then
		local new = math.random(1,6)
		if new == 1 then
			if CurrentWeather == "EXTRASUNNY" then CurrentWeather = "EXTRASUNNY" end
		elseif new == 2 then
			CurrentWeather = "EXTRASUNNY"
		elseif new == 3 then
			CurrentWeather = "EXTRASUNNY"
