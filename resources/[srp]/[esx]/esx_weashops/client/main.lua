...
AddEventHandler('esx_weashop:clipcli', function()
  ...
  if IsPedArmed(ped, 4) then
    ...
    if hash~=nil then
      ...
      ESX.ShowNotification("~b~Użyłeś magazynku do broni...")
    else
      ESX.ShowNotification("~o~Nie masz w ręku broni...")
    end
  else
    ESX.ShowNotification("~o~Ten rodzaj amunicji nie jest odopwiedni do tej broni.")
  end
end)