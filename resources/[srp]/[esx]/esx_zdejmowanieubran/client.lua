...
function OpenActionMenuInteraction(target)
	...
	table.insert(elements, {label = ('Załóż ubrania'), value = 'ubie'})
	table.insert(elements, {label = ('Zdejmij górę'), value = 'tul'})
	table.insert(elements, {label = ('Zdemij dół'), value = 'spo'})
	table.insert(elements, {label = ('Zdejmij buty'), value = 'but'})
