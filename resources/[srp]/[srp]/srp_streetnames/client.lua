			...
			if GetStreetNameFromHashKey(var1) and GetNameOfZone(pos.x, pos.y, pos.z) then
				if GetStreetNameFromHashKey(var1) then
					if direction == 'N' then
							...
							drawTxt(x-0.315, y+0.42, 1.0,1.0,1.0, direction, dir_a)
						if GetStreetNameFromHashKey(var2) == "" then
							drawTxt2(x-0.485, y+0.25, 1.0,1.0,0.45, current_zone, town_r, town_g, town_b, town_a)
						else 
							drawTxt2(x-0.485, y+0.25, 1.0,1.0,0.45, GetStreetNameFromHashKey(var2) .. ", " .. GetLabelText(GetNameOfZone(pos.x, pos.y, pos.z)), str_around_r, str_around_g, str_around_b, str_around_a)
						end
							drawTxt2(x-0.485, y+0.22, 1.0,1.0,0.55, GetStreetNameFromHashKey(var1), curr_street_r, curr_street_g, curr_street_b, curr_street_a)
