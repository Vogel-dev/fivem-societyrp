...
MySQL.Async.execute("UPDATE kaiser_ciuchy SET bag=@bag, bag2=@bag2, tshirt=@tshirt , tshirt2=@tshirt2, torso=@torso, torso2=@torso2, legs=@legs, legs2=@legs2, shoes=@shoes, shoes2=@shoes2, arms=@arms, chain=@chain, chain2=@chain2,mask=@mask,mask2=@mask2,decals=@decals,decals2=@decals2 WHERE identifier=@identifier", {['@identifier'] = identifier, ['@bag'] = bag, ['@bag2'] = bag2, ['@tshirt'] = tshirt, ['@tshirt2'] = tshirt2, ['@torso'] = torso, ['@torso2'] = torso2, ['@legs'] = legs, ['@legs2'] = legs2, ['@shoes'] = shoes, ['@shoes2'] = shoes2,['@arms'] = arms, ['@chain'] = chain, ['@chain2'] = chain2, ['@mask'] = mask, ['@mask2'] = mask2, ['@decals'] = decals, ['@decals2'] = decals2})

 else
 
MySQL.Async.execute("INSERT INTO kaiser_ciuchy (identifier, bag, bag2, tshirt , tshirt2, torso, torso2, legs, legs2, shoes, shoes2, arms, chain, chain2,mask,mask2,decals,decals2) VALUES (@identifier,@bag,@bag2,@tshirt,@tshirt2,@torso,@torso2,@legs,@legs2,@shoes,@shoes2,@arms,@chain,@chain2,@mask,@mask2,@decals,@decals2)", {['@identifier'] = identifier, ['@bag'] = bag, ['@bag2'] = bag2, ['@tshirt'] = tshirt, ['@tshirt2'] = tshirt2, ['@torso'] = torso, ['@torso2'] = torso2, ['@legs'] = legs, ['@legs2'] = legs2, ['@shoes'] = shoes, ['@shoes2'] = shoes2,['@arms'] = arms, ['@chain'] = chain, ['@chain2'] = chain2, ['@mask'] = mask, ['@mask2'] = mask2, ['@decals'] = decals, ['@decals2'] = decals2})
