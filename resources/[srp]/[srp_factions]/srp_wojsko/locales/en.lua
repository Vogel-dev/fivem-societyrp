Locales['pl'] = {
  ...
  ['armory'] = 'Zbrojownia Wojsko',
  ['open_armory'] = 'Wciśnij ~INPUT_CONTEXT~ aby uzyskać dostęp do ~o~zbrojowni.',
  -- Vehicles
  ['vehicle_menu'] = 'Garaż Wojsko',
  ['vehicle_out'] = '~r~Brak pojazdów do wyciągnięcia.',
  ['vehicle_spawner'] = 'Wciśnij ~INPUT_CONTEXT~ aby wyciągnąć ~o~pojazd.',
  ['store_vehicle'] = 'Wciśnij ~INPUT_CONTEXT~ aby schować ~o~pojazd.',
  ...
  ['open_bossmenu'] = 'Wciśnij ~INPUT_CONTEXT~ aby otworzyć menu ~o~Wojsko',
  ['quantity_invalid'] = '~o~Niewłasciwa ilość',
  ['have_withdraw'] = '~y~Zabrałeś x',
  ['added'] = '~b~Włożyłeś x',
  ['quantity'] = 'Ilość',
  ['inventory'] = 'Ekwipunek',
  ['police_stock'] = 'Magazyn Wojsko',
  -- Misc
