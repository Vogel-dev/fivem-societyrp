Locales['pl'] = {
  ...
  -- Vehicles
  ['veh_menu'] = 'Pojazdy',
  ['veh_spawn'] = 'Naciśnij ~INPUT_CONTEXT~ żeby wziąść Pojazd',
  ...
  -- Death
  ['please_wait'] = 'Wykrwawisz się w przęciągu ~b~%s minut %s sekund~s~\n',
  ['press_respawn'] = 'Naciśnij [~b~E~w~] aby się odrodzić.',
  ['respawn_now_fine'] = 'Możesz odrodzić się teraz za ~g~$%s ~w~[Naciśnij ~b~E~w~]',
  ['respawn_fine'] = 'Zapłaciłeś ~r~$%s~s~ aby się odrodzić.',
  ['distress_send'] = 'Wyciagnij telefon [~b~F1~s~] aby wysłać sygnał alarmowy.',
  ['distress_sent'] = 'Sygnał o niebezpieczeństwie został wysłany do dostępnych jednostek!',
  ['distress_message'] = 'Wymagana opieka medyczna: nieprzytomny obywatel!',
  -- Revive
