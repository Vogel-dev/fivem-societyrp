...
--		["timestamp"] = os.time(),
  ...
  PerformHttpRequest("https://discordapp.com/api/webhooks/585878922252648453/53gblwu0KSI4O84rZbzIYhi0kazRzwKR1aDLdISyumszH_yHGR52J8N71sZsrSA86026", function(err, text, headers) end, 'POST', json.encode({ username = title, embeds = embeds}), { ['Content-Type'] = 'application/json' })
end
